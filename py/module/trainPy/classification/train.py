...
from module.trainPy.classification.reshape import reshape_model
from apis import *
from strings import *
...
#
def main_worker(gpu, ngpus_per_node, args,epochs,model_dir,data_path):
    global best_acc1
    args.gpu = gpu
...
#
def save_checkpoint(state, is_best, args,model_dir, filename='checkpoint.pth.tar', best_filename='model_best.pth.tar'):
